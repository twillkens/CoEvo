using CoEvo.Genotypes.FunctionGraphs: FunctionGraphGenotype, FunctionGraphConnection
using CoEvo.Genotypes.FunctionGraphs: FunctionGraphNode
...
function identify_subtree_nodes(
    ...
    while !isempty(nodes_to_visit)
        ...
        if exclude_input_and_bias_nodes && 
            current_node_id ∈ [genotype.input_node_ids ; genotype.bias_node_ids]
            continue
        end
