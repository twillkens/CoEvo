...
function get_invalid_nonrecurrent_targets(
    genotype::SimpleFunctionGraphGenotype, node::Node
)
...
function get_valid_nonrecurrent_edge_targets(genotype::SimpleFunctionGraphGenotype, node::Node)
...
get_valid_nonrecurrent_edge_targets(genotype::SimpleFunctionGraphGenotype, id::Int) = 
...
function get_random_nonrecurrent_edge_target(
    genotype::SimpleFunctionGraphGenotype, node::Node, state::State
)
...
get_random_recurrent_edge_target(genotype::SimpleFunctionGraphGenotype, state::State) = 
...
function relabel_node_ids!(genotype::SimpleFunctionGraphGenotype, counter::Counter)
