...
function get_label_sequence(genotype::SimpleFunctionGraphGenotype)
...
function ==(genotype_1::SimpleFunctionGraphGenotype, genotype_2::SimpleFunctionGraphGenotype)
...
function hash(genotype::SimpleFunctionGraphGenotype, h::UInt)
