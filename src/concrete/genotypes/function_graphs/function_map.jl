...
@kwdef struct ScalarConstantFunction <: GraphFunction 
    name::Symbol = :SCALAR_CONSTANT
    arity::Int = 0
    value::Float32 = 0.0f0
end

@inline function evaluate_function(constant::ScalarConstantFunction)::Float32
...
const FUNCTION_TO_UINT_MAP = Dict{Symbol, UInt8}(
    :INPUT => 1,
    :BIAS => 2,
    :OUTPUT => 3,
    :IDENTITY => 4,
    ...
    :XOR => 19,
    :ARCTANGENT => 20,
    :IF_LESS_THEN_ELSE => 21,
    :MODULO => 22,
    :NATURAL_LOG => 23,
    :EXP => 24
)

const UINT_TO_FUNCTION_MAP = Dict{UInt8, Symbol}(
    1 => :INPUT,
    2 => :BIAS,
    3 => :OUTPUT,
    4 => :IDENTITY,
