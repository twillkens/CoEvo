...
"""
    get_child_index(parent_node::ExpressionNode, child_node::ExpressionNode)

Return the index of `child_node` within the children of `parent_node`. 
"""
function get_child_index(parent_node::ExpressionNode, child_node::ExpressionNode)
...
"""
    get_parent_node(geno::GeneticProgramGenotype, node::ExpressionNode)

Retrieve the parent node of a given `node` in the genotype `geno`.
"""
function get_parent_node(geno::GeneticProgramGenotype, node::ExpressionNode)
...
"""
    get_child_nodes(geno::GeneticProgramGenotype, node::ExpressionNode)

Retrieve children nodes of a given `node` in the genotype `geno`.
"""
function get_child_nodes(geno::GeneticProgramGenotype, node::G) where {G <: ExpressionNode}
...
"""
    get_ancestors(geno::GeneticProgramGenotype, root::ExpressionNode)

Recursively gather all parent nodes of a `root` node in the genotype `geno`.
"""
function get_ancestors(geno::GeneticProgramGenotype, root::G) where {G <: ExpressionNode}
...
"""
    get_descendents(geno::GeneticProgramGenotype, root::ExpressionNode)

Recursively gather all child, grandchild, etc., nodes of a `root` node in the genotype `geno`.
"""
function get_descendents(geno::GeneticProgramGenotype, root::G) where {G <: ExpressionNode}
...
"""
function get_root_node(geno::GeneticProgramGenotype)
