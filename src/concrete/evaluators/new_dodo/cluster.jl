export calculate_clustering_qualities, create_derived_matrix, assign_cluster_ids
...
function get_derived_matrix(
    evaluator::NewDodoEvaluator, raw_matrix::OutcomeMatrix, filtered_matrix::OutcomeMatrix
)
