...
function get_fast_global_clustering_result(
    ...
    current_result = get_kmeans_clustering_result(rng, samples, 1, tolerance, initial_centroids)
    ...
    for cluster_size in 2:max_clusters
        ...
        next_result = get_kmeans_clustering_result(
            rng, samples, cluster_size, tolerance, new_centroids
        )
