...
using .GeneticPrograms.Abstract: ExpressionNodeGene, GeneticProgramGenotype
using .GeneticPrograms.Concrete: BasicGeneticProgramGenotype, BasicExpressionNodeGene
using .GeneticPrograms.Methods: all_nodes, get_ancestors, get_descendents
using .GeneticPrograms.Methods: get_node, get_child_index

using Random: AbstractRNG
using StatsBase: sample, Weights

using ......Genotypes.GeneticPrograms.Concrete: BasicGeneticProgramGenotype, ModiGeneticProgramGenotype  
using ......Genotypes.GeneticPrograms.Methods: all_nodes 
...
function add_function(
    ...
    new_node = BasicExpressionNodeGene(newnode_id, nothing, newnode_val, newnode_child_ids)
