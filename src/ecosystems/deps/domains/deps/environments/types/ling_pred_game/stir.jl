...
function stir(
    oid::Symbol, env::LingPredGame{Control}, obscfg::ObsConfig,
    pheno1::FSMPheno, pheno2::FSMPheno
)
    loopstart, states1, states2, traj1, traj2 = simulate(env, pheno1, pheno2)
    score = 1
...
function stir(
    oid::Symbol, env::LingPredGame{MatchCoop}, obscfg::ObsConfig,
    pheno1::FSMPheno, pheno2::FSMPheno
)
    loopstart, states1, states2, traj1, traj2 = simulate(env, pheno1, pheno2)
...
function stir(
    oid::Symbol, env::LingPredGame{MismatchCoop}, obscfg::ObsConfig,
    pheno1::FSMPheno, pheno2::FSMPheno
)
    loopstart, states1, states2, traj1, traj2 = simulate(env, pheno1, pheno2)
    matches = getmatches(loopstart, traj1, traj2)
...
function stir(
    oid::Symbol, env::LingPredGame{MatchComp}, obscfg::ObsConfig,
    pheno1::FSMPheno, pheno2::FSMPheno
)
    loopstart, states1, states2, traj1, traj2 = simulate(env, pheno1, pheno2)
    matches = getmatches(loopstart, traj1, traj2)
...
function stir(
    oid::Symbol, env::LingPredGame{MismatchComp}, obscfg::ObsConfig,
    pheno1::FSMPheno, pheno2::FSMPheno
)
    loopstart, states1, states2, traj1, traj2 = simulate(env, pheno1, pheno2)
    matches = getmatches(loopstart, traj1, traj2)
