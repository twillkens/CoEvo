...
Construct a NumbersGame Interaction instance using the provided metric.
...
function create_environment(interaction_id::String, env::NumbersGameEnvironmentCreator)
    NumbersGameEnvironment(interaction_id, env.entities, env.metric)
end
