...
export CollisionGameEnvironmentCreator
export CollisionGameEnvironment

using ....Domains.Abstract: Domain
using ....Domains.Concrete: CollisionGameDomain
...
function create_environment(
    ...
    timestep = 1
    return CollisionGameEnvironment(
...
function is_active(environment::CollisionGameEnvironment)
    if episode_is_over(environment)
        return false
    elseif entities_have_collided(environment)
        return false
    else
        return true
    end
