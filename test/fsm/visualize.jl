...
# function plot_geno(geno::FiniteStateMachineGenotype, currstate::Real, seen::Vector{<:Real}, other_outs::Vector{Bool})
...
function plot_geno(
    geno::FiniteStateMachineGenotype, 
    currstate::Real,
    seen::Vector{<:Real}; 
...
function dummy_small1()
    ...
    (2, 1) => 2,
    (2, 0) => 1,)
    FSMIndiv(:dummy, UInt32(1), FiniteStateMachineGenotype(start, ones, zeros, links))
end
function dummy_small2()
    ...
    (2, 1) => 1,
    (2, 0) => 2,)
    FSMIndiv(:dummy, UInt32(2), FiniteStateMachineGenotype(start, ones, zeros, links))
end
function dummy_small3()
    ...
    (2, 1) => 1,
    (2, 0) => 2,)
    FSMIndiv(:dummy, UInt32(3), FiniteStateMachineGenotype(start, ones, zeros, links))
end
...
function plot_pairs(geno1::FiniteStateMachineGenotype, vector1::Vector{<:Pair{<:Real, Bool}}, geno2::FiniteStateMachineGenotype, vector2::Vector{<:Pair{<:Real, Bool}}, until::Int; pair_size::Int = 15, kwargs...)
